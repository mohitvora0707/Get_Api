...
List<CosmeticModel> cosmeticModelFromJson(String str) =>
    List<CosmeticModel>.from(
        json.decode(str).map((x) => CosmeticModel.fromJson(x)));

String cosmeticModelToJson(List<CosmeticModel> data) =>
